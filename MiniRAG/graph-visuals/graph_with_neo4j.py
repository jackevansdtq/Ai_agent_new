...
import sys
import json
sys.path.append('..')  # Thêm path để import minirag
from minirag.utils import xml_to_json
from neo4j import GraphDatabase

# Constants
WORKING_DIR = "../../logs/insurance_rag"  # Thư mục chứa graph data của dự án
BATCH_SIZE_NODES = 500
BATCH_SIZE_EDGES = 100

# Neo4j connection credentials (từ config insurance)
